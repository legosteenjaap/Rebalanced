...
public class TradeOffers {
	...
	public static final Map<VillagerProfession, Int2ObjectMap<TradeOffers.Factory[]>> PROFESSION_TO_LEVELED_TRADE = (Map) Util
			.make(Maps.newHashMap(), (map) -> {
				map.put(VillagerProfession.FARMER, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.WHEAT, 5, 16, 2),
						...
						new TradeOffers.Factory[] { 
								...
								new TradeOffers.SellSuspiciousStewFactory(MobEffects.NIGHT_VISION, 100, 15),
								new TradeOffers.SellSuspiciousStewFactory(MobEffects.JUMP, 160, 15),
								new TradeOffers.SellSuspiciousStewFactory(MobEffects.WEAKNESS, 140, 15),
								new TradeOffers.SellSuspiciousStewFactory(MobEffects.BLINDNESS, 120, 15),
								new TradeOffers.SellSuspiciousStewFactory(MobEffects.POISON, 280, 15),
								new TradeOffers.SellSuspiciousStewFactory(MobEffects.SATURATION, 7, 15) },
				...
				map.put(VillagerProfession.FISHERMAN, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { 
								new TradeOffers.BuySupplyFactory(Items.STRING, 4, 16, 2),
								new TradeOffers.BuySupplyFactory(Items.COAL, 3, 16, 2),
						...
						2,
						new TradeOffers.Factory[] { 
								new TradeOffers.BuySupplyFactory(Items.COD, 10, 16, 10),
						...
						3,
						new TradeOffers.Factory[] { 
								new TradeOffers.BuySupplyFactory(Items.SALMON, 7, 16, 20),
								new TradeOffers.SellEnchantedToolFactory(Items.FISHING_ROD, 3, 3, 10, 0.2F) },
						4,
						new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.TROPICAL_FISH, 3, 12, 30) },
						5,
						new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.PUFFERFISH, 4, 12, 30),
								new TradeOffers.TypeAwareBuySupplyFactory(1, 12, 30,
				...
				map.put(VillagerProfession.SHEPHERD,
						copyToFastUtilMap(ImmutableMap.of(1, 
								new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Blocks.WHITE_WOOL, 8, 16, 2),
								new TradeOffers.BuySupplyFactory(Blocks.BROWN_WOOL, 8, 16, 2),
								new TradeOffers.BuySupplyFactory(Blocks.BLACK_WOOL, 8, 16, 2),
								new TradeOffers.BuySupplyFactory(Blocks.GRAY_WOOL, 8, 16, 2),
								new TradeOffers.SellItemFactory(Items.SHEARS, 2, 1, 1) }, 2,
								new TradeOffers.Factory[] {
										new TradeOffers.BuySupplyFactory(Items.WHITE_DYE, 12, 16, 10),
										new TradeOffers.BuySupplyFactory(Items.GRAY_DYE, 12, 16, 10),
										new TradeOffers.BuySupplyFactory(Items.BLACK_DYE, 12, 16, 10),
										new TradeOffers.BuySupplyFactory(Items.LIGHT_BLUE_DYE, 12, 16, 10),
										new TradeOffers.BuySupplyFactory(Items.LIME_DYE, 12, 16, 10),
								...
								3,
								new TradeOffers.Factory[] {
										new TradeOffers.BuySupplyFactory(Items.YELLOW_DYE, 12, 16, 20),
										new TradeOffers.BuySupplyFactory(Items.LIGHT_GRAY_DYE, 12, 16, 20),
										new TradeOffers.BuySupplyFactory(Items.ORANGE_DYE, 12, 16, 20),
										new TradeOffers.BuySupplyFactory(Items.RED_DYE, 12, 16, 20),
										new TradeOffers.BuySupplyFactory(Items.PINK_DYE, 12, 16, 20),
								...
								4,
								new TradeOffers.Factory[] {
										new TradeOffers.BuySupplyFactory(Items.BROWN_DYE, 12, 16, 30),
										new TradeOffers.BuySupplyFactory(Items.PURPLE_DYE, 12, 16, 30),
										new TradeOffers.BuySupplyFactory(Items.BLUE_DYE, 12, 16, 30),
										new TradeOffers.BuySupplyFactory(Items.GREEN_DYE, 12, 16, 30),
										new TradeOffers.BuySupplyFactory(Items.MAGENTA_DYE, 12, 16, 30),
										new TradeOffers.BuySupplyFactory(Items.CYAN_DYE, 12, 16, 30),
				...
				map.put(VillagerProfession.FLETCHER, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { 
								new TradeOffers.BuySupplyFactory(Items.STICK, 8, 16, 2),
						...
						2,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.FLINT, 2, 12, 10),
								new TradeOffers.SellItemFactory(Items.BOW, 2, 1, 5) },
						3,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.STRING, 5, 16, 20),
								new TradeOffers.SellItemFactory(Items.CROSSBOW, 3, 1, 10) },
						4,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.FEATHER, 12, 16, 30),
								new TradeOffers.SellEnchantedToolFactory(Items.BOW, 2, 3, 15) },
						5,
						new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.TRIPWIRE_HOOK, 6, 12, 30),
								new TradeOffers.SellEnchantedToolFactory(Items.CROSSBOW, 3, 3, 15),
								new TradeOffers.SellPotionHoldingItemFactory(Items.ARROW, 5, Items.TIPPED_ARROW, 5, 2,
										12, 30) })));
				map.put(VillagerProfession.LIBRARIAN, copyToFastUtilMap(ImmutableMap.builder().put(1,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.PAPER, 24, 16, 2),
						...
						.build()));
				map.put(VillagerProfession.CARTOGRAPHER, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.PAPER, 24, 16, 2),
								new TradeOffers.SellItemFactory(Items.MAP, 7, 1, 1) },
						2,
						new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.GLASS_PANE, 11, 16, 10),
								new TradeOffers.SellMapFactory(13, StructureFeature.OCEAN_MONUMENT, MapDecoration.Type.MONUMENT, 12,
										5) },
						3,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.COMPASS, 1, 12, 20),
								new TradeOffers.SellMapFactory(14, StructureFeature.WOODLAND_MANSION, MapDecoration.Type.MANSION, 12,
										10) },
						4,
				...
				map.put(VillagerProfession.CLERIC,
						copyToFastUtilMap(ImmutableMap.of(1, new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.ROTTEN_FLESH, 12, 16, 2),
								new TradeOffers.SellItemFactory(Items.REDSTONE, 1, 2, 1) }, 2,
								new TradeOffers.Factory[] {
										new TradeOffers.BuySupplyFactory(Items.GOLD_INGOT, 3, 12, 10),
										new TradeOffers.SellItemFactory(Items.LAPIS_LAZULI, 1, 1, 5) },
								3,
								new TradeOffers.Factory[] {
										new TradeOffers.BuySupplyFactory(Items.RABBIT_FOOT, 2, 12, 20),
										new TradeOffers.SellItemFactory(Blocks.GLOWSTONE, 4, 1, 12, 10) },
								4,
								new TradeOffers.Factory[] {
										//new TradeOffers.BuySupplyFactory(Items.SCUTE, 4, 12, 30),
										new TradeOffers.BuySupplyFactory(Items.GLASS_BOTTLE, 3, 12, 30),
										new TradeOffers.SellItemFactory(Items.ENDER_PEARL, 5, 1, 15) },
								5,
								new TradeOffers.Factory[] {
										//new TradeOffers.BuySupplyFactory(Items.NETHER_WART, 22, 12, 30),
										new TradeOffers.SellItemFactory(Items.EXPERIENCE_BOTTLE, 3, 1, 30) })));
				map.put(VillagerProfession.ARMORER, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.COAL, 5, 16, 2),
								...
								new TradeOffers.SellItemFactory(new ItemStack(Items.IRON_CHESTPLATE), 9, 1, 12, 1,
										0.2F) },
						2,
						new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.IRON_INGOT, 4, 12, 10),
								new TradeOffers.SellItemFactory(new ItemStack(Items.BELL), 36, 1, 12, 5, 0.2F),
								new TradeOffers.SellItemFactory(new ItemStack(Items.CHAINMAIL_BOOTS), 1, 1, 12, 5,
										0.2F),
								new TradeOffers.SellItemFactory(new ItemStack(Items.CHAINMAIL_LEGGINGS), 3, 1, 12, 5,
										0.2F) },
						3,
						new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.LAVA_BUCKET, 1, 12, 20),
								new TradeOffers.BuyForOneEmeraldFactory(Items.DIAMOND, 1, 12, 20),
								new TradeOffers.SellItemFactory(new ItemStack(Items.CHAINMAIL_HELMET), 1, 1, 12, 10,
										0.2F),
								new TradeOffers.SellItemFactory(new ItemStack(Items.CHAINMAIL_CHESTPLATE), 4, 1, 12, 10,
										0.2F),
						...
						new TradeOffers.Factory[] {
								...
								new TradeOffers.SellEnchantedToolFactory(Items.DIAMOND_CHESTPLATE, 16, 3, 30,
										0.2F) })));
				map.put(VillagerProfession.WEAPONSMITH, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.COAL, 5, 16, 2),
						...
						new TradeOffers.Factory[] {
								...
								new TradeOffers.SellItemFactory(new ItemStack(Items.BELL), 36, 1, 12, 5, 0.2F) },
						3,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.FLINT, 24, 12, 20) },
						4,
						
						new TradeOffers.Factory[] { new TradeOffers.BuyForOneEmeraldFactory(Items.DIAMOND, 1, 12, 30),
				...
				map.put(VillagerProfession.TOOLSMITH, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.COAL, 15, 16, 2),
						...
						new TradeOffers.Factory[] {
								...
								new TradeOffers.SellItemFactory(new ItemStack(Items.BELL), 36, 1, 12, 5, 0.2F) },
						3,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.FLINT, 30, 12, 20),
						...
						4,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.DIAMOND, 1, 12, 30),
								new TradeOffers.SellEnchantedToolFactory(Items.DIAMOND_AXE, 12, 3, 15, 0.2F),
				...
				map.put(VillagerProfession.BUTCHER, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.CHICKEN, 14, 16, 2),
								new TradeOffers.BuySupplyFactory(Items.PORKCHOP, 7, 16, 2),
								new TradeOffers.BuySupplyFactory(Items.RABBIT, 4, 16, 2),
						...
						3,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.MUTTON, 7, 16, 20),
								new TradeOffers.BuySupplyFactory(Items.BEEF, 10, 16, 20) },
						4,
						new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.DRIED_KELP_BLOCK, 5, 12, 30) },
						5, new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.SWEET_BERRIES, 10, 12, 30) })));
				map.put(VillagerProfession.LEATHERWORKER, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.LEATHER, 6, 16, 2),
						...
						2,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.FLINT, 26, 12, 10),
						...
						3,
						new TradeOffers.Factory[] {
								new TradeOffers.BuySupplyFactory(Items.RABBIT_HIDE, 9, 12, 20),
								new TradeOffers.SellDyedArmorFactory(Items.LEATHER_CHESTPLATE, 7) },
						4,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.SCUTE, 4, 12, 30),
				...
				map.put(VillagerProfession.MASON, copyToFastUtilMap(ImmutableMap.of(1,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.CLAY_BALL, 10, 16, 2),
								new TradeOffers.SellItemFactory(Items.BRICK, 1, 10, 16, 1) },
						2,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Blocks.STONE, 20, 16, 10),
								new TradeOffers.SellItemFactory(Blocks.CHISELED_STONE_BRICKS, 1, 4, 16, 5) },
						3,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Blocks.GRANITE, 16, 16, 20),
								new TradeOffers.BuySupplyFactory(Blocks.ANDESITE, 16, 16, 20),
								new TradeOffers.BuySupplyFactory(Blocks.DIORITE, 16, 16, 20),
						...
						4,
						new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.QUARTZ, 12, 12, 30),
						...
						5,
						new TradeOffers.Factory[] { new TradeOffers.SellItemFactory(Blocks.QUARTZ_PILLAR, 1, 1, 12, 30),
	...
	private static Int2ObjectMap<TradeOffers.Factory[]> copyToFastUtilMap(ImmutableMap<Object, Object> immutableMap) {
		return new Int2ObjectOpenHashMap(immutableMap);
	}

	static {
		WANDERING_TRADER_TRADES = copyToFastUtilMap(ImmutableMap.of(1,
				new TradeOffers.Factory[] { new TradeOffers.SellItemFactory(Items.SEA_PICKLE, 2, 1, 5, 1),
				...
				2,
				new TradeOffers.Factory[] { new TradeOffers.SellItemFactory(Items.TROPICAL_FISH_BUCKET, 5, 1, 4, 1),
	...
	static class ProcessItemFactory implements TradeOffers.Factory {
		...
		public ProcessItemFactory(ItemLike item, int secondCount, Item sellItem, int sellCount, int maxUses,
				int experience) {
			this(item, secondCount, 1, sellItem, sellCount, maxUses, experience);
		}

		public ProcessItemFactory(ItemLike item, int secondCount, int price, Item sellItem, int sellCount,
		...
		@Nullable
		public MerchantOffer create(Entity entity, Random random) {
	...
	static class SellMapFactory implements TradeOffers.Factory {
		...
		public SellMapFactory(int price, StructureFeature<?> feature, MapDecoration.Type iconType, int maxUses,
				int experience) {
			this.price = price;
		...
		public MerchantOffer create(Entity entity, Random random) {
			if (!(entity.level instanceof ServerLevel)) {
				...
				if (blockPos != null) {
					ItemStack itemStack = MapItem.create(serverWorld, blockPos.getX(), blockPos.getZ(),
							(byte) 2, true, true);
					...
					itemStack.setHoverName(
							new TranslatableComponent("filled_map." + this.structure.getFeatureName().toLowerCase(Locale.ROOT)));
					return new MerchantOffer(new ItemStack(Items.EMERALD, this.price), new ItemStack(Items.COMPASS),
	...
	static class EnchantBookFactory implements TradeOffers.Factory {
		...
		public MerchantOffer create(Entity entity, Random random) {
			...
			List<Enchantment> list = (List) Registry.ENCHANTMENT.stream().filter(Enchantment::isTreasureOnly)
	...
	static class SellPotionHoldingItemFactory implements TradeOffers.Factory {
		...
		public SellPotionHoldingItemFactory(Item arrow, int secondCount, Item tippedArrow, int sellCount, int price,
				int maxUses, int experience) {
		...
		public MerchantOffer create(Entity entity, Random random) {
			...
			ItemStack itemStack2 = PotionUtils.setPotion(new ItemStack(this.sell.getItem(), this.sellCount), potion);
			return new MerchantOffer(itemStack, new ItemStack(this.secondBuy, this.secondCount), itemStack2, this.maxUses,
					this.experience, this.priceMultiplier);
		}
	}
	...
	public static class SellItemFactory implements TradeOffers.Factory {
		...
		public MerchantOffer createWanderingTraderDeal (Entity entity, Random random) {
			return new MerchantOffer(new ItemStack(this.sell.getItem(), this.count), new ItemStack(Items.EMERALD, this.price),
	...
	static class TypeAwareBuySupplyFactory implements TradeOffers.Factory {
		private final Map<VillagerType, Item> map;
		private final int count;
		private final int maxUses;
		private final int experience;

		public TypeAwareBuySupplyFactory(int count, int maxUses, int experience, Map<VillagerType, Item> map) {
			Registry.VILLAGER_TYPE.stream().filter((villagerType) -> {
				return !map.containsKey(villagerType);
			}).findAny().ifPresent((villagerType) -> {
				throw new IllegalStateException(
						"Missing trade for villager type: " + Registry.VILLAGER_TYPE.getKey(villagerType));
			});
			this.map = map;
			this.count = count;
			this.maxUses = maxUses;
		...
		public MerchantOffer create(Entity entity, Random random) {
			if (entity instanceof VillagerDataHolder) {
				ItemStack itemStack = new ItemStack(
						(ItemLike) this.map.get(((VillagerDataHolder) entity).getVillagerData().getType()),
						this.count);
				return new MerchantOffer(new ItemStack(Items.EMERALD), itemStack, this.maxUses, this.experience, 0.05F);
			} else {
				return null;
			}
		}
	...
	public static class BuySupplyFactory implements TradeOffers.Factory {
		...
		public BuySupplyFactory(ItemLike item, int price, int maxUses, int experience) {
		...
		public MerchantOffer createBuySupply(Entity entity, Random random) {
		...
		public MerchantOffer create(Entity entity, Random random) {
			return new MerchantOffer(new ItemStack(Items.EMERALD),
	...
	public interface Factory {
		 ...
		 */
		@Nullable
		MerchantOffer create(Entity entity, Random random);
	}
}
