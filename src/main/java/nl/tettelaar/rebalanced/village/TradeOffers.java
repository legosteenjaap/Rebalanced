...
public class TradeOffers {
            ...
            .make(Maps.newHashMap(), (map) -> {
                ...
                map.put(VillagerProfession.CARTOGRAPHER, copyToFastUtilMap(ImmutableMap.of(1,
                        ...
                        new TradeOffers.Factory[] {
                                ...
                                new TradeOffers.SellMapFactory(13, ConfiguredStructureTags.ON_OCEAN_EXPLORER_MAPS, "filled_map.monument", MapDecoration.Type.MONUMENT, 12,
                                        5) },
                        3,
                        new TradeOffers.Factory[] { new TradeOffers.BuySupplyFactory(Items.COMPASS, 1, 12, 20),
                                new TradeOffers.SellMapFactory(14, ConfiguredStructureTags.ON_WOODLAND_EXPLORER_MAPS, "filled_map.mansion", MapDecoration.Type.MANSION, 12,
                                        10) },
                        4,
    ...
    static class SellMapFactory implements TradeOffers.Factory {
        ...
        public SellMapFactory(int price, TagKey<ConfiguredStructureFeature<?, ?>> destination, String displayName, MapDecoration.Type destinationType, int maxUses,
                              int experience) {
            this.price = price;
        ...
        public MerchantOffer create(Entity entity, Random random) {
            ...
            if (blockPos != null) {
                ...
                return new MerchantOffer(new ItemStack(Items.EMERALD, this.price), new ItemStack(Items.COMPASS), itemStack, this.maxUses, this.experience, 0.2f);
            }
            return null;
        }
    }
