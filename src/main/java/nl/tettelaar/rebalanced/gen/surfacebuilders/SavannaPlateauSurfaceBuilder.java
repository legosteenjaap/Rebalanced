...
public class SavannaPlateauSurfaceBuilder extends SurfaceBuilder<TernarySurfaceConfig> {

    public SavannaPlateauSurfaceBuilder(Codec<TernarySurfaceConfig> codec) {
        super(codec);
    }
