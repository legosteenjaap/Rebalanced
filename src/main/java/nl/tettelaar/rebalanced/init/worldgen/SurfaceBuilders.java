...
public class SurfaceBuilders {
	...
	public static void init() {
		Registry.register(Registry.SURFACE_BUILDER, new Identifier(modid, "savanna_beach"), BiomeCreator.SAVANNA_BEACH_SURFACE);
		Registry.register(Registry.SURFACE_BUILDER, new Identifier(modid, "savanna_plateau"), BiomeCreator.SAVANNA_PLATEAU_SURFACE);
		...
		Registry.register(Registry.SURFACE_BUILDER, new Identifier(modid, "snowy_stone_shore"), BiomeCreator.SNOWY_STONE_SHORE_SURFACE);

		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new Identifier(modid, "savanna_plateau"), BiomeCreator.CONFIGURED_SAVANNA_PLATEAU_SURFACE);
		...
		Registry.register(BuiltinRegistries.CONFIGURED_SURFACE_BUILDER, new Identifier(modid, "snowy_stone_shore"), BiomeCreator.CONFIGURED_SNOWY_STONE_SHORE_SURFACE);
